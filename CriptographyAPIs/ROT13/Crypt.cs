...
public class Crypt
{
    public static ObjectResult ClearText(string clearText)
    {
        var bored = "abcdefghijklmnopqrstuvwxyz";
        var alphabet = bored.ToCharArray();
        var toLower = clearText.ToLower();
        ...
        var tempFlag = clearText.Replace(" ", string.Empty);
